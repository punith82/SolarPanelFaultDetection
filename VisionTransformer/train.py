"""
WHY THIS FILE?
This is the main training file for Vision Transformer (ViT).

It:
1. Loads dataset
2. Preprocesses images
3. Loads Vision Transformer model
4. Trains model
5. Evaluates model
...
# ---------------------------------------------------
# vit_b16 is a common ViT variant; you can change patch_size or image_size as needed
